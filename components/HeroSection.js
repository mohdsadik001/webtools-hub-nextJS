      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div>
          ...
          <div className="flex justify-center gap-4 mb-12 mt-8">
            <button onClick={() => router.push("/tools")}className="bg-primary text-white px-12 py-3 rounded-lg hover:bg-primary-dull transition-colors cursor-pointer">{t("exploreButton")} →</button>
          </div>
          <Categories />
        </div>
      </div>
