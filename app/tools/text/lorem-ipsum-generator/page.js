      ...
      <fieldset className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-5 w-full">
        ...
        <div className="flex items-end">
          <button
            ...
            className={`generate-button flex gap-2 items-center justify-center w-full px-2 py-2 sm:py-3 rounded text-base sm:text-lg min-h-[44px] touch-manipulation transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 ${
              isGenerating 
