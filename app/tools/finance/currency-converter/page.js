...
import { ArrowLeftRight, DollarSign } from "lucide-react"; // ✅ Lucide icons
  ...
  return (
    <main className="mt-2 md:mt-8 flex flex-col px-4 md:px-12 lg:px-20 xl:px-32 py-6">
      ...
      <div className="flex flex-col items-end self-start">
        <h1 className="text-xl md:text-3xl font-semibold uppercase text-gray-800">{t("currencyConverterTitle")}</h1>
      ...
      <div className="grid grid-cols-1 relative md:grid-cols-3 gap-2 md:gap-4 mt-4 md:mt-6 items-end">
        ...
        <div>
          ...
          <input
            ...
            className="border border-gray-400 px-3 py-3 rounded-md outline-primary w-full"
            type="number"
